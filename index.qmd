...
* **Quarto Updates**
  ...
  + **Quarto + Typst** is the future of PDF; faster/better rendering and easier code [[Link](https://quarto.org/docs/output-formats/typst.html)]
    ...
    + Session notes: [[Link](sessions_day2.qmd#sec-typstexample)]
  + **New Quarto Extensions** [[Link](https://quarto.org/docs/extensions/)]
    + **Closeread**: Interactive, scroll-based **scrollytelling** [[Link](closeread.netlify.app) | [GitHub](https://github.com/qmd-lab/closeread)]
      + Session notes: [[Link](sessions_day2.qmd#sec-closeread)]
    + **Quarto Live** for interactive code snippets/exercises powered by WebAssembly + Observable JS (useful for educational materials) [[Link](https://r-wasm.github.io/quarto-live/) | [GitHub](https://github.com/r-wasm/quarto-live)]
